...
export default {
  ...
  .navbar {
    ...
    justify-content: flex-end; /* Pour ajouter de l'espace entre les éléments */
    padding: 20px; /* Pour un peu d'espace à l'intérieur de la barre de navigation */
  }
  
  .nav-item {
    margin-right: 60px; /* Ajoute de l'espace entre les éléments */
    margin-top: 5px;
  }
